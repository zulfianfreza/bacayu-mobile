...
- Prefers UI icons/artwork wired as replaceable asset files (loaded by asset path) so they can swap the artwork themselves later without code changes ("siapkan untuk mengambil dari asset image, nanti saya ubah sendiri"). Confidence: 0.6
